export const portfolioData = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "부동산 매매 및 임대업을 하며 주거용·상업용 부동산 거래에 관심이 많아요. IT 스타트업에서 STO와 DeFi 업무를 했던 경험으로 Wep/app 개발 · 배포 · 출시 업무를 진행하고, 결제회사에서 근무한 경력을 바탕으로 가상자산에도 투자하고 있어요. 여러 분야를 경험해보면서 새로운 것을 배우는 재미를 느끼고 있습니다."
    ],
    achievements: [
      "온라인 쇼핑몰 3개 운영",
