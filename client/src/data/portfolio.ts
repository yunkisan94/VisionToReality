export const portfolioData = {
  ...
  about: {
    ...
    paragraphs: [
      "안녕하세요, 저는 윤기산입니다. 스타트업 전략기획팀과 금융공기업에서 경험을 쌓은 후, 지금은 Witter, Orpu, Haute 세 개의 온라인 쇼핑몰을 운영하고 있어요. 기업에서 배운 전략적 사고를 개인 사업에 적용하며 조금씩 성장시켜 나가고 있습니다.",
      "부동산 매매 및 임대업을 하며 주거용·상업용 부동산 거래에 관심이 많아요. IT 스타트업에서 STO와 DeFi 업무를 했던 경험으로 Web/app 개발 · 배포 · 출시 업무를 진행하고, 결제회사에서 근무한 경력을 바탕으로 가상자산에도 투자하고 있어요. 여러 분야를 경험해보면서 새로운 것을 배우는 재미를 느끼고 있습니다.",
    ],
    achievements: [
      "온라인 쇼핑몰 3개 운영",
      "부동산 투자 및 관리 경험(6년 경력)",
      "Web/app 개발·배포·출시",
      "스타트업-STO/DeFi 사업 전략 수립",
    ],
  },
  ...
  projects: [
    {
      ...
      description:
        "사용자 맞춤형 심리 분석 질문 생성 및 결과 리포트 제공. GPT API, Stripe 결제, 캐릭터 성장 시스템, Notion 로그 연동. Replit + Capacitor 기반으로 Android 앱으로 배포하여 Google Play Console에 AAB 등록 및 비공개 테스트 진행 중.",
      image:
    ...
    },
    {
      title: "Witter",
      description:
        "패션과 라이프스타일 제품을 판매하는 프리미엄 온라인 쇼핑몰. 독특한 고객 경험과 고품질 제품으로 차별화.",
      image:
    ...
    },
    {
      title: "Haute",
      description:
        "홈 인테리어와 생활용품을 판매하는 프리미엄 온라인 스토어. 공간별 맞춤형 제품 큐레이션과 홈스타일링 서비스로 차별화된 쇼핑 경험 제공.",
      image:
    ...
    },
    {
      title: "상업용 부동산 포트폴리오",
      description:
        "전략적 위치에 있는 상업용 부동산 투자 및 관리. 장기적인 가치 상승과 안정적인 임대 수익 창출.",
      image:
    ...
    },
    {
      title: "가상자산 투자 전략",
      description:
        "현물 및 선물 시장에서의 체계적인 가상자산 투자 전략 수립 및 실행. 리스크 관리와 장기적 수익 추구.",
      image:
